...
function Navigation() {
  return ( 
    <nav className='navigation'>
      <a href="/" className='navigation__item navigation__item--active-stroke'>
        <span className='navigation__item-content'>
          <span className='navigation__item-image'>
          ...
          <p className='navigation__item-name'>Dashboard</p>
        </span>
      </a>

      <a href="/" className='navigation__item navigation__item--active-fill'>
        <span className='navigation__item-content'>
          <span className='navigation__item-image'>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className='navigation__item-name'>Product</p>
        </span>
        <span className='navigation__item-mark'>
      ...
      <a href="/" className='navigation__item navigation__item--active-fill navigation__item--pressed-fill'>
        <span className='navigation__item-content'>
          <span className='navigation__item-image'>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className='navigation__item-name'>Customers</p>
        </span>
        <span className='navigation__item-mark navigation__item-mark--pressed'>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 12L10 8L6 4" stroke="#9197B3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </span>
      ...
      <a href="/" className='navigation__item navigation__item--active-stroke'>
        <span className='navigation__item-content'>
          <span className='navigation__item-image'>
           <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10.7516 16.8604V18.8904C10.7516 20.6104 9.15158 22.0004 7.18158 22.0004C5.21158 22.0004 3.60156 20.6104 3.60156 18.8904V16.8604C3.60156 18.5804 5.20158 19.8004 7.18158 19.8004C9.15158 19.8004 10.7516 18.5704 10.7516 16.8604Z" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M10.7501 14.11C10.7501 14.61 10.6101 15.07 10.3701 15.47C9.78006 16.44 8.57004 17.05 7.17004 17.05C5.77004 17.05 4.56003 16.43 3.97003 15.47C3.73003 15.07 3.59009 14.61 3.59009 14.11C3.59009 13.25 3.99007 12.48 4.63007 11.92C5.28007 11.35 6.17003 11.01 7.16003 11.01C8.15003 11.01 9.04006 11.36 9.69006 11.92C10.3501 12.47 10.7501 13.25 10.7501 14.11Z" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M10.7516 14.11V16.86C10.7516 18.58 9.15158 19.8 7.18158 19.8C5.21158 19.8 3.60156 18.57 3.60156 16.86V14.11C3.60156 12.39 5.20158 11 7.18158 11C8.17158 11 9.06161 11.35 9.71161 11.91C10.3516 12.47 10.7516 13.25 10.7516 14.11Z" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M22 10.9699V13.03C22 13.58 21.56 14.0299 21 14.0499H19.0399C17.9599 14.0499 16.97 13.2599 16.88 12.1799C16.82 11.5499 17.0599 10.9599 17.4799 10.5499C17.8499 10.1699 18.36 9.94995 18.92 9.94995H21C21.56 9.96995 22 10.4199 22 10.9699Z" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M2 10.5V8.5C2 5.78 3.64 3.88 6.19 3.56C6.45 3.52 6.72 3.5 7 3.5H16C16.26 3.5 16.51 3.50999 16.75 3.54999C19.33 3.84999 21 5.76 21 8.5V9.95001H18.92C18.36 9.95001 17.85 10.17 17.48 10.55C17.06 10.96 16.82 11.55 16.88 12.18C16.97 13.26 17.96 14.05 19.04 14.05H21V15.5C21 18.5 19 20.5 16 20.5H13.5" stroke="#9197B3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </span>
          <p className='navigation__item-name'>Income</p>
        </span>
        <span className='navigation__item-mark'>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 12L10 8L6 4" stroke="#9197B3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <a href="/" className='navigation__item navigation__item--active-fill'>
        <span className='navigation__item-content'>
          ...
          <p className='navigation__item-name'>Promote</p>
        </span>
        <span className='navigation__item-mark'>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 12L10 8L6 4" stroke="#9197B3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <a href="/" className='navigation__item navigation__item--active-fill'>
        <span className='navigation__item-content'>
          ...
          <p className='navigation__item-name'>Help</p>
        </span>
        <span className='navigation__item-mark'>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 12L10 8L6 4" stroke="#9197B3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
